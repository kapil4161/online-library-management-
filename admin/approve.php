      ...
      function closeNav() {
        ...
        <div class="container">
              ...
              <form class="Approve" action="" method="post">
                ...
                <input class="form-control" type="text" name="ret" placeholder="Return Date yyyy-mm-dd" required=""><br>
...
<?php
  ...
  {
        mysqli_query($db,"UPDATE `issue_book` SET `approve`='$_POST[approve]',  `issue`=    '$_POST[issue]' ,   `ret`=     ' $_POST[ret]'    where username='$_SESSION[st_name]' and bid='$_SESSION[bid]';");
